...
created: "2026-07-20T14:26:02.295Z"
...
```json
{
  ...
  "agentDecision": {
    ...
    "reasoningSummary": [
      "codex: Iniciar a iteração deep com descoberta e caracterização passiva da superfície do alvo.",
      "codex: Priorizar módulos de base que produzam evidências para selecionar auditorias deep_passive em iterações posteriores.",
      "codex: As memórias disponíveis referem-se a outros alvos e servem apenas como precedente operacional, não como evidência sobre www.dfimoveis.com.br.",
      "codex: Todos os módulos solicitados existem no catálogo, estão disponíveis e são classificados como não intrusivos."
    ],
    "evidenceRefs": [],
    "requestedModules": [
      "subdomains",
